...
public class ResourceBundleMessageSource extends AbstractMessageSource implements BeanClassLoaderAware {
     ...
     * Edit: Reading JSON Properties Resource Bundles (.json)
     * @author Anibal Gomez <anibalogmez@icloud.com>
    ...
    /**
     * Integration to Spring Framework
     * Can be used to build up a resource bundle based on a JSON file
     *
     * Usage: <code>ResourceBundle rb = ResourceBundle.getBundle("messages", new Locale("nl"), new JSonResourceBundleControl());</code>
     * System.out.println( rb.getString("title") );
     * Ref: http://bright-bits.blogspot.mx/2011/12/java-resourcebundle-based-on-json-files.html
     *
    ...
    public class JSonResourceBundleControl extends ResourceBundle.Control {
        ...
        public ResourceBundle newBundle(String baseName, Locale locale, String format, ClassLoader loader, boolean reload) throws IllegalAccessException, InstantiationException, IOException {
            ...
            for (Object key : jsonObject.keySet()) {
                rb.put(key.toString(), jsonObject.get(key));
            }

            return rb;
        }

        private class JSonResourceBundle extends ResourceBundle {
